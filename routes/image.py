...
@api.route('/update_image/<int:id>', methods=['PUT'])
@jwt_required()
@check_token_revoked
@swag_from({
    'tags': ['Image'],
...
@api.route('/list_all_images', methods=['Get'])
@jwt_required()
@check_token_revoked
@swag_from({
    'tags': ['Image'],
...
@api.route('/get_image/<int:id>', methods=['GET'])
@jwt_required()
@check_token_revoked
@swag_from({
    'tags': ['Image'],
...
@api.route('/delete_image/<int:id>', methods=['DELETE'])
@jwt_required()
@check_token_revoked
@swag_from({
    'tags': ['Image'],
