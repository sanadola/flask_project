...
from db import db
from models.tabular import TabularData
from utils.auth_helpers import check_token_revoked

api = Blueprint('api', __name__)


# =====================================================================================================
#                                  Creating a Tabular From User
# ======================================================================================================

@api.route('/create_tabular', methods=['POST'])
@jwt_required()
@check_token_revoked
@swag_from({
    'tags': ['Tabular'],
...
def create_tabular():
    ...
    new_data = TabularData(tabular_data=data, tabular_name=tabular_name)
...
# ======================================================================================================================
@api.route('/update_tabular/<int:id>', methods=['PUT'])
@jwt_required()
@check_token_revoked
@swag_from({
    'tags': ['Tabular'],
...
@api.route('/list_all_tabular', methods=['GET'])
@jwt_required()
@check_token_revoked
@swag_from({
    'tags': ['Tabular'],
...
@api.route('/get_tabular/<int:id>', methods=['GET'])
@jwt_required()
@check_token_revoked
@swag_from({
    'tags': ['Tabular'],
...
@api.route('/delete_tabular/<int:id>', methods=['DELETE'])
@jwt_required()
@check_token_revoked
@swag_from({
    'tags': ['Tabular'],
